...
export class BSTreeMemento extends Memento<BSTreeNode | undefined, string> {
    ...
    addBlank(codeRef: any, tree: BSTreeNode | undefined,
        heapSize?: number, nodeRoles: NodeRole[] = [], visitedNodes: number[] = [],
    ...
    addSwap(codeRef: any, tree: BSTreeNode | undefined, index1: number,
        index2: number, heapSize?: number, nodeRoles: NodeRole[] = [],
        visitedNodes: number[] = [], passedNodes: number[] = [], traversalResults: number[] = []) {
        this.snapshots.push({
    ...
    addSnapshot(codeRef: any, tree: BSTreeNode | undefined,
        index: number, action: ActionType, nodeRoles: NodeRole[] = []
        , visitedNodes: number[] = [], passedNodes: number[] = [], traversalResults: number[] = []) {
        this.snapshots.push({
    ...
    addDoubleSnapShot(codeRef: any, tree: BSTreeNode | undefined,
        index1: number, index2: number, action: ActionType,
        nodeRoles: NodeRole[] = [], visitedNodes: number[] = [],
        passedNodes: number[] = [], traversalResults: number[] = []) {
        this.snapshots.push({
