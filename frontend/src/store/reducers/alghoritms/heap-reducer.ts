...
const initialState = {root:arrayToBinaryTree(heapArray),currentActions:[] as Events,currentArr:heapArray};
...
export const {setRoot,setActions,setArray} = heapSlice.actions;
